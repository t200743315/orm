...
public class TableContext {
	...
	static {
		...
		//更新类结构 启动框架就更新
		//updateJavaPOFile();
		//loadPOTables(); 放到QueryFactory中加载,避免 updateJavaPOFile(); 还没加载完,就加载loadPOTables() 出现异常
	}
	...
	public static void updateJavaPOFile(){
		...
		for(TableInfo t:map.values()){
			JavaFileUtils.creatJavaFile(t, new MysqlTypeConvertor());
		}	
	}
	...
	public static void loadPOTables(){
		...
		for(TableInfo tableInfo:tables.values()){
			try {
				...
				poClassTableMap.put(c, tableInfo);//将clazz与表关联
